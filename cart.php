...
<body background="images/ac2.png">
<div class=""></div>
...
<tr>
      <td colspan="7">
        <h5 class="text-center text-info m-0"><font color="Red"><b>PRODUCTS IN YOUR CART!</b></font></h5>
      </td>
    </tr>  
...
<td > <input type="number" class="form-control itemQty" value="<?=$row['qty']?>" style="width: 75pt;"></td>
 
 <td>₱ <?=number_format($row['total_price'],2); ?></td>
<td>  <a href="action.php?remove=<?= $row['id']?>" class="text-danger  lead" onclick="return  confirm('Are you sure to remove this item? ');"> <b> Delete </b></a>
</td>
</tr>
...
<tr>
  <td colspan="3">
    <a href="indexx.php" class="btn btn-success">Continue Shopping </a>
  </td>
<td colspan="2"><b>Grand Total</b></td>
<td>₱ <?=number_format($grand_total);?> </td>
<td><a href="checkout.php" class="btn btn-info <?=($grand_total>1)?"":"disabled"; ?>">Checkout</td>
